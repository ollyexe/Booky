...
class appointmentsByProfAndBySubject extends StatefulWidget {
  String prof;
  String subject;
  appointmentsByProfAndBySubject(this.prof,this.subject,{Key? key}) : super(key: key);

  @override
  State<appointmentsByProfAndBySubject> createState() => _appointmentsByProfAndBySubjectState();
}

class _appointmentsByProfAndBySubjectState extends State<appointmentsByProfAndBySubject> {
